    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#08080F]">
      ...
      <div className="pointer-events-none absolute inset-0 select-none">
        ...
        >
          ...
          {Array.from({ length: 16 }, (_, i) => {
            ...
            return (
              <line key={`r${i}`} x1="720" y1="900" x2={x2} y2={y2} stroke="#C9A84C" strokeWidth="0.5" />
            );
          })}
        </svg>
        ...
        <svg
          ...
          fill="none"
        >
          <circle cx="100" cy="100" r="95" stroke="#C9A84C" strokeWidth="1" />
          <circle cx="100" cy="100" r="65" stroke="#C9A84C" strokeWidth="0.6" />
          <circle cx="100" cy="100" r="20" stroke="#C9A84C" strokeWidth="1.2" />
          {Array.from({ length: 5 }, (_, i) => {
            const a = (i / 5) * Math.PI * 2;
            return (
              <line key={i}
                x1={100 + Math.cos(a) * 20} y1={100 + Math.sin(a) * 20}
                x2={100 + Math.cos(a) * 65} y2={100 + Math.sin(a) * 65}
      ...
      <div className="relative z-10 mx-4 w-full max-w-md">
        ...
        <p className="mt-6 text-center text-xs text-white/20">
          © {new Date().getFullYear()} Conneqt · CNPJ 41.359.070/0001-18
        </p>
      </div>
    </div>
  );
