...
export default function InspecaoPage() {
  ...
  return (
    /* Full screen sem nav inferior (BottomNav já a exclui para /vender/inspecao) */
    <div className="min-h-screen bg-gray-50 pb-6">
      {/* Header fixo */}
      <div className="sticky top-0 z-30 border-b border-gray-200 bg-white/95 backdrop-blur-sm px-4 py-3">
        <div className="mx-auto flex max-w-lg items-center gap-3">
          <Link href="/vender" className="rounded-full p-2 hover:bg-gray-100">
        ...
        <div className="mt-6 space-y-2">
          {UPLOAD_STEPS.map((stepItem, i) => (
            ...
            >
              ...
              <span
                className={`text-sm ${i < currentStep ? 'font-medium text-green-700' : 'text-gray-700'}`}
              >
                {stepItem.label}
              </span>
            </div>
